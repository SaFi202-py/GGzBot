...
TEMPLATE_COMMANDS = {
    '!discord': ' {message.user} إنضموا إلى سيرفر الدسكورد: https://discord.gg/vG7v4kXraF',
    '!so': 'يلا يا جماعة روحوا ادعموا الستريمر  {message.text_args[0]}, twitch.tv/{message.text_args[0]}',
}


MODERATORS = {'safi_ggz', 'hadimr11_ggz', 'atem_ggz' , 'nureen_beautu_ggz' , 'ogman_ggz' , 'pika_ggz' , 'wissam_ggz' ,}
...
class Bot:
    def __init__(self):
        ...
        self.username = 'ggz_bot'
        self.channels = ['pika_ggz', ]
    ...
    def connect(self):
        ...
        for channel in self.channels:
            ...
            self.send_privmsg(channel, 'Meeeee isssss online')
    ...
    def handle_message(self, received_msg):
        ...
        if message.irc_command == 'PRIVMSG':
            if message.text_command == '!so':
                if message.user in MODERATORS:
            ...
            elif message.text_command in self.custom_commands:
